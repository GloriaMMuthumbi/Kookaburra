    ...
    return ( 
        <section className="my-12">
            ...
            <div className="flex items-center justify-center">
                <button className="font-poppins uppercase bg-white text-darkblue-500 border border-darkblue-500 rounded-xl w-36 h-10 transition-colors duration-350 text-sm font-bold">More Projects</button>
            </div>
        </section>
    );
}
